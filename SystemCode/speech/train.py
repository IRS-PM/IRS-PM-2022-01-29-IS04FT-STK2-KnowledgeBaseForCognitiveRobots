...
intents = json.loads(open(sdir+'intents.json').read())
...
pickle.dump(words,open('speech/words.pkl','wb'))
pickle.dump(classes,open('speech/classes.pkl','wb'))
...
model.save('speech/chatbot_model.h5', history)
